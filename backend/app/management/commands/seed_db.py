...
class Command(BaseCommand):
    ...
    # Deleting all existing data
        ...
        photo3 = Photo.objects.create(url='https://a0.muscache.com/im/pictures/miso/Hosting-17234604/original/2a9bef54-6ce1-4417-6243-286fb994bd6f.jpeg?im_w=720', alt_text='Photo 3')
        ...
        property1.room.add(room1, room2, room3)
        ...
        property2.room.add(room1, room4)
        ...
        review1 = Review.objects.create(
            reviewer=user3,property=property1,
